  ...
  return (
    <section className="px-4 py-16 sm:px-6 sm:py-20 md:py-24">
      <div className="mx-auto grid max-w-5xl items-center gap-8 md:grid-cols-2 md:gap-12">
        <Reveal>
          <div className="relative mx-auto w-full max-w-[13rem] [perspective:900px] min-[390px]:max-w-[14.5rem] sm:max-w-xs sm:[perspective:1200px]">
        ...
        <Reveal direction="left" delay={0.15} className="text-center md:text-left">
          <p className="mb-2 text-xs uppercase tracking-[0.28em] text-[var(--color-silver)]/80 min-[390px]:tracking-[0.35em]">{BOOK_CONTENT.title}</p>
          <h2 className="font-serif text-[clamp(2rem,10vw,2.5rem)] leading-tight text-white">{BOOK_CONTENT.bookName}</h2>
          <p className="mx-auto mt-4 max-w-md text-base leading-relaxed text-white/80 md:mx-0">{BOOK_CONTENT.text}</p>
